"""Evaluate XGBoost model performance (ROC/AUC/KS)."""
...
def main() -> None:
    ...
    metrics_path = FIGURES_DIR / "tables" / "xgb_metrics.csv"
    metrics_path.parent.mkdir(parents=True, exist_ok=True)
    metrics.to_csv(metrics_path, index=False)

    save_roc_curve(y_true, y_score, FIGURES_DIR / "plots" / "xgb_roc.png")
    print(f"Saved metrics: {metrics_path}")
    print(f"Saved ROC: {FIGURES_DIR / 'plots' / 'xgb_roc.png'}")

"""SHAP interpretability for Random Forest model."""
...
def main() -> None:
    """Compute SHAP explanations for Random Forest."""
    ...
    plot_path = FIGURES_DIR / "plots" / "rf_shap_summary.png"
    ...
    importance = pd.DataFrame(
        {"feature": X_test.columns, "mean_abs_shap": abs(shap_values).mean(axis=0)}
    ).sort_values("mean_abs_shap", ascending=False)

    table_path = FIGURES_DIR / "tables" / "rf_shap_importance.csv"
